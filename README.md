...
### Особенности:
- Одно правило по умолчанию: блокировка рекламы (geosite:category-ads-all).
- Добавление своего (!) warp для маршрутизации ру трафика.
- Создание опциональных правил для: торрентов (блокировать или нет) и ру трафика (блокировать или в warp).
